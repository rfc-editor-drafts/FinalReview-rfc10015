...
informative:
  ...
  ICA:
    ...
    author:
      ...
      - ins: J. Schwenk
      - ins: J. Somorovsky
# Note to PE: Updated YAML for ICA
#  ICA:
#    title: "Practical invalid curve attacks on TLS-ECDH"
...
#      - ins: J. Schwenk
#      - ins: J. Somorovsky
#    refcontent: SORICS 2015, Part I, Lecture Notes in Computer Science, vol. 9326, pp. 407-425
#    seriesinfo:
...
listed in {{deprecated-rha-cs}} in {{rsacs}}. Note that these cipher suites are
