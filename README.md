# Final Review for RFC-to-be 10015 (draft-ietf-tls-deprecate-obsolete-kex-08) (in markdown)

This repository is for managing document updates for RFC 10015 during Final Review (previously AUTH48). This is part of the [pilot GitHub-based process for Final Review](https://www.rfc-editor.org/rpc/wiki/doku.php?id=rpc_github_roadmap), and it emulates the [current Final Review procedure](https://authors.ietf.org/en/rfc-publication-process). 

Please see the [License](https://github.com/rfc-editor-drafts/FinalReview-rfc10015/blob/Approved/LICENSE). The [IETF Note Well](https://github.com/rfc-editor-drafts/FinalReview-rfc10015/blob/Approved/note-well.md) applies.
...
The initial version of rfc10015.md is a copy of the Internet-Draft (in markdown) as it was approved for publication. A pull request has been created that contains all the edits made by the RFC Production Center (RPC). This emulates the starting state of the [current Final Review procedure](https://authors.ietf.org/en/rfc-publication-process). 
...
* [https://www.rfc-editor.org/authors/rfc10015.html](https://www.rfc-editor.org/authors/rfc10015.html)
* [https://www.rfc-editor.org/authors/rfc10015.pdf](https://www.rfc-editor.org/authors/rfc10015.pdf)
* [https://www.rfc-editor.org/authors/rfc10015.txt](https://www.rfc-editor.org/authors/rfc10015.txt)
* [https://www.rfc-editor.org/authors/rfc10015.xml](https://www.rfc-editor.org/authors/rfc10015.xml)

The following diff files are also available via www.rfc-editor.org:
* [https://www.rfc-editor.org/authors/rfc10015-diff.html](https://www.rfc-editor.org/authors/rfc10015-diff.html) (all changes since the document entered the RFC Editor Queue)
* [https://www.rfc-editor.org/authors/rfc10015-rfcdiff.html](https://www.rfc-editor.org/authors/rfc10015-rfcdiff.html) (side-by-side view of all changes since the document entered the RFC Editor Queue)
* [https://www.rfc-editor.org/authors/rfc10015-alt-diff.html](https://www.rfc-editor.org/authors/rfc10015-alt-diff.html) (shows changes where text was moved/deleted)
...
Details about the status of your Final Review are here: [https://queue.rfc-editor.org/final-review/rfc10015/](https://queue.rfc-editor.org/final-review/rfc10015/)
